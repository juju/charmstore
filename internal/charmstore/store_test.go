...
var findBestEntityTests = []struct {
	...
	// This behaviour might be controversial.
...
var findBestEntityWithMultiSeriesCharmsTests = []struct {
	...
	about: "URL with no series and revision will not find bundle",
	entities: []*mongodoc.Entity{{
	...
	about: "promulgated URL with no series and revision will not find bundle",
	entities: []*mongodoc.Entity{{
		URL:            charm.MustParseReference("~charmers/bundle/trundle-10"),
